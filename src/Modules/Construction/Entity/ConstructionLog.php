...
namespace App\Modules\Construction\Entity;
...
ConstructionLog
{
    ...
    public static function fromCompleted(PlanetConstruction $construction): static
    {
    ...
    public static function fromCancelled(PlanetConstruction $construction): static
    {
        $log = new ConstructionLog();
        $log->setBuildingName($construction->getBuildingName());
        $log->setLevel($construction->getLevel());
